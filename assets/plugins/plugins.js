...
!function(e, t) {
    ...
    var t = function(e, t) {
      ...
      , i = function(e, t) {
        ...
        for (o = 0; o < e.length; o++)
            e[o]instanceof google.maps.LatLng || (e[o].length > 0 && "object" == typeof e[o][0] ? e[o] = i(e[o], t) : e[o] = r(e[o], t));
        return e
    }
      , s = function(e, t) {
        var o, n = e.replace(".", "");
      ...
      , p = function(e) {
        var o = document
          , n = function(e) {
            ...
            if ("string" == typeof e.el || "string" == typeof e.div ? u.indexOf("#") > -1 ? this.el = a(u, e.context) : this.el = s.apply(this, [u, e.context]) : this.el = u,
            ...
            r = 0; r < h.length; r++)
                delete e[h[r]];
            for (1 != e.disableDefaultUI && (O = t(O, P)),
            C = t(O, e),
            r = 0; r < c.length; r++)
                delete C[c[r]];
            ...
            var T = function(e, t) {
                ...
                if (a("gmaps_context_menu")) {
                    ...
                    s.innerHTML = o;
                    var r, c = s.getElementsByTagName("a"), g = c.length;
                    for (r = 0; g > r; r++) {
                        var h = c[r]
                          , u = function(o) {
                            o.preventDefault(),
            ...
            google.maps.event.addListener(this.map, "rightclick", function(t) {
                ...
                void 0 != window.context_menu[p.el.id].map && p.buildContextMenu("map", t)
            }),
    ...
    p.prototype.createControl = function(e) {
        ...
        e.disableDefaultStyles !== !0 && (t.style.fontFamily = "Roboto, Arial, sans-serif",
    ...
    p.prototype.removeControl = function(e) {
        ...
        for (t = 0; t < this.controls.length; t++)
            this.controls[t] == e && (o = this.controls[t].position,
    ...
    p.prototype.createMarker = function(e) {
        ...
        for (var g = ["animation_changed", "clickable_changed", "cursor_changed", "draggable_changed", "flat_changed", "icon_changed", "position_changed", "shadow_changed", "shape_changed", "title_changed", "visible_changed", "zindex_changed"], h = ["dblclick", "drag", "dragend", "dragstart", "mousedown", "mouseout", "mouseover", "mouseup"], c = 0; c < g.length; c++)
            !function(t, o) {
        ...
        return google.maps.event.addListener(l, "click", function() {
            ...
            l.infoWindow && (o.hideInfoWindows(),
            l.infoWindow.open(o.map, l))
        }),
        google.maps.event.addListener(l, "rightclick", function(t) {
            t.marker = this,
            e.rightclick && e.rightclick.apply(this, [t]),
            void 0 != window.context_menu[o.el.id].marker && o.buildContextMenu("marker", t)
        }),
    ...
    p.prototype.drawOverlay = function(e) {
        ...
        t.onRemove = function() {
            var o = t.el;
            e.remove ? e.remove.apply(this, [o]) : (t.el.parentNode.removeChild(t.el),
            t.el = null)
        }
        ,
    ...
    p.prototype.drawPolyline = function(e) {
        ...
        return this.polylines.push(s),
        p.fire("polyline_added", s, this),
        s
    }
    ,
    ...
    p.prototype.drawPolygon = function(e) {
        ...
        e.paths.length > 0 && e.paths[0].length > 0 && (e.paths = n(o(e.paths, i, r)));
        ...
        return this.polygons.push(s),
        p.fire("polygon_added", s, this),
        s
    }
    ,
    ...
    p.prototype.addLayer = function(e, t) {
        ...
        case "panoramio":
            ...
            o.setTag(t.filter),
            delete t.filter,
            t.click && google.maps.event.addListener(o, "click", function(e) {
                t.click(e),
                delete t.click
            });
            break;
        ...
        return void 0 !== o ? ("function" == typeof o.setOptions && o.setOptions(t),
    ...
    p.prototype.drawSteppedRoute = function(e) {
        ...
        if (e.origin && e.destination)
            this.getRoutes({
                ...
                error: e.error,
                callback: function(o) {
                    if (o.length > 0 && e.start && e.start(o[o.length - 1]),
                    o.length > 0 && e.step) {
                        var n = o[o.length - 1];
                        if (n.legs.length > 0)
    ...
    p.staticMapURL = function(e) {
        ...
        if (i)
            for (var h, u, d = 0; o = i[d]; d++) {
                h = [],
                o.size && "normal" !== o.size ? (h.push("size:" + o.size),
                delete o.size) : o.icon && (h.push("icon:" + encodeURI(o.icon)),
                delete o.icon),
                o.color && (h.push("color:" + o.color.replace("#", "0x")),
                delete o.color),
                o.label && (h.push("label:" + o.label[0].toUpperCase()),
                delete o.label),
                ...
                h.length || 0 === d ? (h.push(u),
                h = h.join("|"),
                n.push("markers=" + encodeURI(h))) : (h = n.pop() + encodeURI("|" + u),
                n.push(h))
            }
        if (s)
            for (var d = 0; d < s.length; d++) {
                var m = [];
                s[d].featureType && m.push("feature:" + s[d].featureType.toLowerCase()),
                s[d].elementType && m.push("element:" + s[d].elementType.toLowerCase());
        ...
        if (a) {
            ...
            var b = o.path;
            if (b.join)
                for (var _, f = 0; _ = b[f]; f++)
                    a.push(_.join(","));
            else
                a.push("enc:" + b);
            a = a.join("|"),
            n.push("path=" + encodeURI(a))
        }
        var M = window.devicePixelRatio || 1;
        return n.push("scale=" + M),
        n = n.join("&"),
        r + n
    }
    ,
    ...
    ,
    p.off = function(e, t) {
        -1 == p.custom_events.indexOf(e) ? (t instanceof p && (t = t.map),
        google.maps.event.clearListeners(t, e)) : t.registered_events[e] = []
    }
    ,
    p.once = function(e, t, o) {
        return -1 == p.custom_events.indexOf(e) ? (t instanceof p && (t = t.map),
        google.maps.event.addListenerOnce(t, e, o)) : void 0
    }
    ,
